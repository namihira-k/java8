 ...
 */
public class TwitterWithLambda {
    ...
    public TwitterWithLambda(ClockPanel clockPanel) {
        ...
        /*** use a Lambda ***/
        button.addActionListener(event -> getTimeLine());
        /*********************/
        ...
        /*** use a Lambda ***/
        tweetButton.addActionListener(event -> updateTwitterStatus());
        /*********************/
