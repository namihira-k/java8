...
public class ImageUtilsTest {
    ...
    public void test_getHueImageTransformer() {
        ...
        final Image result = LatentImage.form(in)
                .transform(ImageUtils.getHueImageTransformer(0, (int)in.getWidth() - 1,
                        0, (int)in.getHeight() - 1))
                .toImage();
    ...
    public void test_getEdgeImageTransformer() {
        ...
        // action
        final Image result = LatentImage.form(in)
                .transform(ImageUtils.getEdgeImageTransformer(0, (int)in.getWidth() - 1,
                        0, (int)in.getHeight() - 1))
                .toImage();
